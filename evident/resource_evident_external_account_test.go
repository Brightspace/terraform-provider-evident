	...
	resource.Test(t, resource.TestCase{
		...
		* variables are added . skipped for now.
		...
		Steps: []resource.TestStep{
			{
				Config: testEvidentExternalAccountConfig(fakeArn, fakeName, fakeExternalId, fakeTeamId),
...
func testEvidentExternalAccountConfig(arn, name, externalId, teamId string) string {
	return fmt.Sprintf(`
